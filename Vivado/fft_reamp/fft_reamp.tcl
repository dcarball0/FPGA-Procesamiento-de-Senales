...
#
# fft_reamp.tcl: Tcl script for re-creating project 'fft_reamp'
#
# Generated by Vivado on Mon Jun 24 20:56:31 +0200 2024
...
#
# 1. This project restoration tcl script (fft_reamp.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "D:/TFG/_proyecto/fft_reamp/fft_reamp.srcs/sources_1/new/AXI_Gain.vhd"
#    "D:/TFG/_proyecto/fft_reamp/fft_reamp.srcs/sources_1/new/AXI_Clip.vhd"
#    "D:/TFG/_proyecto/fft_reamp/fft_reamp.srcs/sources_1/new/AudioClipper.vhd"
#    "D:/TFG/_proyecto/fft_reamp/base.xdc"
#    "D:/TFG/_proyecto/fft_reamp/fft_reamp.srcs/utils_1/imports/synth_1/fft_reamp_wrapper.dcp"
#
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/fft_reamp.srcs/sources_1/new/AXI_Gain.vhd"]"\
 "[file normalize "$origin_dir/fft_reamp.srcs/sources_1/new/AXI_Clip.vhd"]"\
 "[file normalize "$origin_dir/fft_reamp.srcs/sources_1/new/AudioClipper.vhd"]"\
 "[file normalize "$origin_dir/base.xdc"]"\
 "[file normalize "$origin_dir/fft_reamp.srcs/utils_1/imports/synth_1/fft_reamp_wrapper.dcp"]"\
  ]
  foreach ifile $files {
...
set_property -name "board_part_repo_paths" -value "C:/Users/deica/AppData/Roaming/Xilinx/Vivado/2023.2/xhub/board_store/xilinx_board_store" -objects $obj
...
set_property -name "top" -value "fft_reamp_wrapper" -objects $obj
...
set file "synth_1/fft_reamp_wrapper.dcp"
...
if { [get_files [list AXI_Gain.vhd]] == "" } {
  import_files -quiet -fileset sources_1 D:/TFG/_proyecto/fft_reamp/fft_reamp.srcs/sources_1/new/AXI_Gain.vhd
}
if { [get_files [list AXI_Clip.vhd]] == "" } {
  import_files -quiet -fileset sources_1 D:/TFG/_proyecto/fft_reamp/fft_reamp.srcs/sources_1/new/AXI_Clip.vhd
}
if { [get_files [list AudioClipper.vhd]] == "" } {
  import_files -quiet -fileset sources_1 D:/TFG/_proyecto/fft_reamp/fft_reamp.srcs/sources_1/new/AudioClipper.vhd
}


# Proc to create BD fft_reamp
proc cr_bd_fft_reamp { parentCell } {
# The design that will be created by this Tcl proc contains the following 
# module references:
# AXI_Gain, AXI_Clip, AXI_Rectification



  # CHANGE DESIGN NAME HERE
  set design_name fft_reamp
...
# Hierarchical cell: audio_block
proc create_hier_cell_audio_block { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_audio_block() - Empty argument(s)!"}
     return
  }
  ...
  # Create instance: audio_dma, and set properties
  set audio_dma [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_dma:7.1 audio_dma ]
  ...
  # Create instance: rect_dma, and set properties
  set rect_dma [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_dma:7.1 rect_dma ]
  set_property -dict [list \
  ...
  # Create instance: AXI_Clip_0, and set properties
  set block_name AXI_Clip
  set block_cell_name AXI_Clip_0
  if { [catch {set AXI_Clip_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $AXI_Clip_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  # Create instance: clip_dma, and set properties
  set clip_dma [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_dma:7.1 clip_dma ]
  set_property -dict [list \
    CONFIG.c_include_s2mm {0} \
    CONFIG.c_include_sg {0} \
    CONFIG.c_m_axi_mm2s_data_width {32} \
  ...
  # Create instance: gain_dma, and set properties
  set gain_dma [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_dma:7.1 gain_dma ]
  set_property -dict [list \
    CONFIG.c_include_s2mm {0} \
    CONFIG.c_include_sg {0} \
    CONFIG.c_m_axi_mm2s_data_width {32} \
  ...
  connect_bd_intf_net -intf_net AXI_Clip_0_m_axis [get_bd_intf_pins audio_dma/S_AXIS_S2MM] [get_bd_intf_pins AXI_Clip_0/m_axis]
  connect_bd_intf_net -intf_net AXI_Gain_0_m_axis [get_bd_intf_pins AXI_Gain_0/m_axis] [get_bd_intf_pins AXI_Rectification_0/s_axis]
  connect_bd_intf_net -intf_net AXI_Rectification_0_m_axis [get_bd_intf_pins AXI_Clip_0/s_axis] [get_bd_intf_pins AXI_Rectification_0/m_axis]
  connect_bd_intf_net -intf_net Conn1 [get_bd_intf_pins M_AXI_MM2S1] [get_bd_intf_pins gain_dma/M_AXI_MM2S]
  connect_bd_intf_net -intf_net Conn2 [get_bd_intf_pins audio_dma/M_AXI_MM2S] [get_bd_intf_pins M_AXI_MM2S]
  connect_bd_intf_net -intf_net Conn3 [get_bd_intf_pins S_AXI_LITE1] [get_bd_intf_pins gain_dma/S_AXI_LITE]
  connect_bd_intf_net -intf_net Conn4 [get_bd_intf_pins rect_dma/M_AXI_MM2S] [get_bd_intf_pins M_AXI_MM2S2]
  connect_bd_intf_net -intf_net Conn5 [get_bd_intf_pins rect_dma/S_AXI_LITE] [get_bd_intf_pins S_AXI_LITE2]
  connect_bd_intf_net -intf_net Conn6 [get_bd_intf_pins S_AXI_LITE3] [get_bd_intf_pins clip_dma/S_AXI_LITE]
  connect_bd_intf_net -intf_net Conn7 [get_bd_intf_pins M_AXI_MM2S3] [get_bd_intf_pins clip_dma/M_AXI_MM2S]
  connect_bd_intf_net -intf_net audio_dma_M_AXIS_MM2S [get_bd_intf_pins audio_dma/M_AXIS_MM2S] [get_bd_intf_pins AXI_Gain_0/s_axis]
  connect_bd_intf_net -intf_net audio_dma_M_AXI_S2MM [get_bd_intf_pins M_AXI_S2MM] [get_bd_intf_pins audio_dma/M_AXI_S2MM]
  connect_bd_intf_net -intf_net clip_dma_M_AXIS_MM2S [get_bd_intf_pins AXI_Clip_0/threshold] [get_bd_intf_pins clip_dma/M_AXIS_MM2S]
  connect_bd_intf_net -intf_net gain_dma_M_AXIS_MM2S [get_bd_intf_pins AXI_Gain_0/gain] [get_bd_intf_pins gain_dma/M_AXIS_MM2S]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M02_AXI [get_bd_intf_pins S_AXI_LITE] [get_bd_intf_pins audio_dma/S_AXI_LITE]
  connect_bd_intf_net -intf_net rect_dma_M_AXIS_MM2S [get_bd_intf_pins rect_dma/M_AXIS_MM2S] [get_bd_intf_pins AXI_Rectification_0/rect]

  # Create port connections
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins m_axi_s2mm_aclk] [get_bd_pins audio_dma/m_axi_s2mm_aclk] [get_bd_pins audio_dma/s_axi_lite_aclk] [get_bd_pins audio_dma/m_axi_mm2s_aclk] [get_bd_pins AXI_Gain_0/clk] [get_bd_pins rect_dma/m_axi_mm2s_aclk] [get_bd_pins rect_dma/s_axi_lite_aclk] [get_bd_pins AXI_Clip_0/clk] [get_bd_pins AXI_Rectification_0/clk] [get_bd_pins clip_dma/s_axi_lite_aclk] [get_bd_pins clip_dma/m_axi_mm2s_aclk] [get_bd_pins gain_dma/s_axi_lite_aclk] [get_bd_pins gain_dma/m_axi_mm2s_aclk]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins axi_resetn] [get_bd_pins audio_dma/axi_resetn] [get_bd_pins AXI_Gain_0/rst] [get_bd_pins rect_dma/axi_resetn] [get_bd_pins AXI_Clip_0/rst] [get_bd_pins AXI_Rectification_0/rst] [get_bd_pins clip_dma/axi_resetn] [get_bd_pins gain_dma/axi_resetn]
...
proc create_hier_cell_fft_block { parentCell nameHier } {
  ...
  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_fft_block() - Empty argument(s)!"}
     return
  }
  ...
  # Create instance: datos_dma, and set properties
  set datos_dma [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_dma:7.1 datos_dma ]
  set_property -dict [list \
    CONFIG.c_include_sg {0} \
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net Conn1 [get_bd_intf_pins datos_dma/M_AXI_MM2S] [get_bd_intf_pins M_AXI_MM2S]
  connect_bd_intf_net -intf_net Conn2 [get_bd_intf_pins datos_dma/M_AXI_S2MM] [get_bd_intf_pins M_AXI_S2MM]
  connect_bd_intf_net -intf_net Conn3 [get_bd_intf_pins config_dma/M_AXI_MM2S] [get_bd_intf_pins M_AXI_MM2S1]
  connect_bd_intf_net -intf_net Conn4 [get_bd_intf_pins datos_dma/S_AXI_LITE] [get_bd_intf_pins S_AXI_LITE]
  connect_bd_intf_net -intf_net Conn5 [get_bd_intf_pins config_dma/S_AXI_LITE] [get_bd_intf_pins S_AXI_LITE1]
  connect_bd_intf_net -intf_net config_dma_M_AXIS_MM2S [get_bd_intf_pins xfft_0/S_AXIS_CONFIG] [get_bd_intf_pins config_dma/M_AXIS_MM2S]
  connect_bd_intf_net -intf_net datos_dma_M_AXIS_MM2S [get_bd_intf_pins datos_dma/M_AXIS_MM2S] [get_bd_intf_pins xfft_0/S_AXIS_DATA]
  connect_bd_intf_net -intf_net xfft_0_M_AXIS_DATA [get_bd_intf_pins xfft_0/M_AXIS_DATA] [get_bd_intf_pins datos_dma/S_AXIS_S2MM]

  # Create port connections
  connect_bd_net -net aclk_1 [get_bd_pins aclk] [get_bd_pins xfft_0/aclk] [get_bd_pins datos_dma/m_axi_mm2s_aclk] [get_bd_pins datos_dma/m_axi_s2mm_aclk] [get_bd_pins datos_dma/s_axi_lite_aclk] [get_bd_pins config_dma/m_axi_mm2s_aclk] [get_bd_pins config_dma/s_axi_lite_aclk]
  connect_bd_net -net aresetn_1 [get_bd_pins aresetn] [get_bd_pins xfft_0/aresetn] [get_bd_pins datos_dma/axi_resetn] [get_bd_pins config_dma/axi_resetn]
...
\
  ...
  # Create instance: audio_block
  create_hier_cell_audio_block [current_bd_instance .] audio_block

  # Create interface connections
  connect_bd_intf_net -intf_net S00_AXI_1 [get_bd_intf_pins axi_mem_intercon/S00_AXI] [get_bd_intf_pins fft_block/M_AXI_MM2S1]
  connect_bd_intf_net -intf_net S01_AXI_1 [get_bd_intf_pins axi_mem_intercon/S01_AXI] [get_bd_intf_pins fft_block/M_AXI_MM2S]
  connect_bd_intf_net -intf_net S02_AXI_1 [get_bd_intf_pins axi_mem_intercon/S02_AXI] [get_bd_intf_pins fft_block/M_AXI_S2MM]
  connect_bd_intf_net -intf_net S04_AXI_1 [get_bd_intf_pins axi_mem_intercon/S04_AXI] [get_bd_intf_pins audio_block/M_AXI_MM2S]
  connect_bd_intf_net -intf_net S05_AXI_1 [get_bd_intf_pins axi_mem_intercon/S05_AXI] [get_bd_intf_pins audio_block/M_AXI_MM2S1]
  connect_bd_intf_net -intf_net S06_AXI_1 [get_bd_intf_pins axi_mem_intercon/S06_AXI] [get_bd_intf_pins audio_block/M_AXI_MM2S2]
  connect_bd_intf_net -intf_net S07_AXI_1 [get_bd_intf_pins axi_mem_intercon/S07_AXI] [get_bd_intf_pins audio_block/M_AXI_MM2S3]
  connect_bd_intf_net -intf_net audio_dma_M_AXI_S2MM [get_bd_intf_pins audio_block/M_AXI_S2MM] [get_bd_intf_pins axi_mem_intercon/S03_AXI]
  connect_bd_intf_net -intf_net axi_mem_intercon_M00_AXI [get_bd_intf_pins axi_mem_intercon/M00_AXI] [get_bd_intf_pins processing_system7_0/S_AXI_HP0]
  connect_bd_intf_net -intf_net processing_system7_0_DDR [get_bd_intf_ports DDR] [get_bd_intf_pins processing_system7_0/DDR]
  connect_bd_intf_net -intf_net processing_system7_0_FIXED_IO [get_bd_intf_ports FIXED_IO] [get_bd_intf_pins processing_system7_0/FIXED_IO]
  connect_bd_intf_net -intf_net processing_system7_0_M_AXI_GP0 [get_bd_intf_pins processing_system7_0/M_AXI_GP0] [get_bd_intf_pins ps7_0_axi_periph/S00_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins ps7_0_axi_periph/M00_AXI] [get_bd_intf_pins fft_block/S_AXI_LITE1]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M01_AXI [get_bd_intf_pins ps7_0_axi_periph/M01_AXI] [get_bd_intf_pins fft_block/S_AXI_LITE]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M02_AXI [get_bd_intf_pins ps7_0_axi_periph/M02_AXI] [get_bd_intf_pins audio_block/S_AXI_LITE]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M03_AXI [get_bd_intf_pins ps7_0_axi_periph/M03_AXI] [get_bd_intf_pins audio_block/S_AXI_LITE1]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M04_AXI [get_bd_intf_pins ps7_0_axi_periph/M04_AXI] [get_bd_intf_pins audio_block/S_AXI_LITE2]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M05_AXI [get_bd_intf_pins ps7_0_axi_periph/M05_AXI] [get_bd_intf_pins audio_block/S_AXI_LITE3]

  # Create port connections
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/S01_ACLK] [get_bd_pins axi_mem_intercon/S02_ACLK] [get_bd_pins fft_block/aclk] [get_bd_pins axi_mem_intercon/S03_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins audio_block/m_axi_s2mm_aclk] [get_bd_pins axi_mem_intercon/S04_ACLK] [get_bd_pins axi_mem_intercon/S05_ACLK] [get_bd_pins ps7_0_axi_periph/M03_ACLK] [get_bd_pins axi_mem_intercon/S06_ACLK] [get_bd_pins ps7_0_axi_periph/M04_ACLK] [get_bd_pins axi_mem_intercon/S07_ACLK] [get_bd_pins ps7_0_axi_periph/M05_ACLK]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins rst_ps7_0_100M/peripheral_aresetn] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins axi_mem_intercon/M00_ARESETN] [get_bd_pins axi_mem_intercon/ARESETN] [get_bd_pins axi_mem_intercon/S01_ARESETN] [get_bd_pins axi_mem_intercon/S02_ARESETN] [get_bd_pins fft_block/aresetn] [get_bd_pins axi_mem_intercon/S03_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins audio_block/axi_resetn] [get_bd_pins axi_mem_intercon/S04_ARESETN] [get_bd_pins axi_mem_intercon/S05_ARESETN] [get_bd_pins ps7_0_axi_periph/M03_ARESETN] [get_bd_pins axi_mem_intercon/S06_ARESETN] [get_bd_pins ps7_0_axi_periph/M04_ARESETN] [get_bd_pins axi_mem_intercon/S07_ARESETN] [get_bd_pins ps7_0_axi_periph/M05_ARESETN]

  # Create address segments
  assign_bd_address -offset 0x40420000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs audio_block/audio_dma/S_AXI_LITE/Reg] -force
  assign_bd_address -offset 0x40400000 -range 0x00010000 -with_name SEG_axi_dma_0_Reg -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs fft_block/config_dma/S_AXI_LITE/Reg] -force
  assign_bd_address -offset 0x40450000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs audio_block/clip_dma/S_AXI_LITE/Reg] -force
  assign_bd_address -offset 0x40410000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs fft_block/datos_dma/S_AXI_LITE/Reg] -force
  assign_bd_address -offset 0x40430000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs audio_block/gain_dma/S_AXI_LITE/Reg] -force
  assign_bd_address -offset 0x40440000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs audio_block/rect_dma/S_AXI_LITE/Reg] -force
  assign_bd_address -offset 0x00000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces fft_block/datos_dma/Data_MM2S] [get_bd_addr_segs processing_system7_0/S_AXI_HP0/HP0_DDR_LOWOCM] -force
  assign_bd_address -offset 0x00000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces fft_block/datos_dma/Data_S2MM] [get_bd_addr_segs processing_system7_0/S_AXI_HP0/HP0_DDR_LOWOCM] -force
  ...
  assign_bd_address -offset 0x00000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces audio_block/audio_dma/Data_MM2S] [get_bd_addr_segs processing_system7_0/S_AXI_HP0/HP0_DDR_LOWOCM] -force
  assign_bd_address -offset 0x00000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces audio_block/audio_dma/Data_S2MM] [get_bd_addr_segs processing_system7_0/S_AXI_HP0/HP0_DDR_LOWOCM] -force
  assign_bd_address -offset 0x00000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces audio_block/rect_dma/Data_MM2S] [get_bd_addr_segs processing_system7_0/S_AXI_HP0/HP0_DDR_LOWOCM] -force
  assign_bd_address -offset 0x00000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces audio_block/clip_dma/Data_MM2S] [get_bd_addr_segs processing_system7_0/S_AXI_HP0/HP0_DDR_LOWOCM] -force
  assign_bd_address -offset 0x00000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces audio_block/gain_dma/Data_MM2S] [get_bd_addr_segs processing_system7_0/S_AXI_HP0/HP0_DDR_LOWOCM] -force

  # Perform GUI Layout
  regenerate_bd_layout -layout_string {
   "ActiveEmotionalView":"Default View",
   "Default View_ScaleFactor":"0.608569",
   "Default View_TopLeft":"-311,3",
   "ExpandedHierarchyInLayout":"",
   "guistr":"# # String gsaved with Nlview 7.5.8 2022-09-21 7111 VDI=41 GEI=38 GUI=JA:10.0
#  -string -flagsOSRD
preplace port DDR -pg 1 -lvl 6 -x 1800 -y 840 -defaultsOSRD
preplace port FIXED_IO -pg 1 -lvl 6 -x 1800 -y 870 -defaultsOSRD
preplace inst processing_system7_0 -pg 1 -lvl 5 -x 1560 -y 900 -defaultsOSRD
preplace inst ps7_0_axi_periph -pg 1 -lvl 2 -x 520 -y 250 -defaultsOSRD
preplace inst rst_ps7_0_100M -pg 1 -lvl 1 -x 190 -y 440 -defaultsOSRD
preplace inst axi_mem_intercon -pg 1 -lvl 4 -x 1200 -y 460 -defaultsOSRD
preplace inst fft_block -pg 1 -lvl 3 -x 840 -y 100 -defaultsOSRD
preplace inst audio_block -pg 1 -lvl 3 -x 840 -y 310 -defaultsOSRD
preplace netloc processing_system7_0_FCLK_CLK0 1 0 6 20 340 360 470 680 190 1030 800 1340 1010 1780
preplace netloc processing_system7_0_FCLK_RESET0_N 1 0 6 20 1020 NJ 1020 NJ 1020 NJ 1020 NJ 1020 1770
preplace netloc rst_ps7_0_100M_peripheral_aresetn 1 1 3 370 480 690 200 990
preplace netloc S00_AXI_1 1 3 1 1050 120n
preplace netloc S01_AXI_1 1 3 1 1060 80n
preplace netloc S02_AXI_1 1 3 1 1040 100n
preplace netloc S04_AXI_1 1 3 1 1010 270n
preplace netloc S05_AXI_1 1 3 1 1020 290n
preplace netloc S06_AXI_1 1 3 1 N 310
preplace netloc S07_AXI_1 1 3 1 N 330
preplace netloc audio_dma_M_AXI_S2MM 1 3 1 1000 250n
preplace netloc axi_mem_intercon_M00_AXI 1 4 1 1350 460n
preplace netloc processing_system7_0_DDR 1 5 1 1780J 840n
preplace netloc processing_system7_0_FIXED_IO 1 5 1 NJ 870
preplace netloc processing_system7_0_M_AXI_GP0 1 1 5 380 790 NJ 790 NJ 790 NJ 790 1770
preplace netloc ps7_0_axi_periph_M00_AXI 1 2 1 670 80n
preplace netloc ps7_0_axi_periph_M01_AXI 1 2 1 660 60n
preplace netloc ps7_0_axi_periph_M02_AXI 1 2 1 670 240n
preplace netloc ps7_0_axi_periph_M03_AXI 1 2 1 660 260n
preplace netloc ps7_0_axi_periph_M04_AXI 1 2 1 N 280
preplace netloc ps7_0_axi_periph_M05_AXI 1 2 1 N 300
levelinfo -pg 1 0 190 520 840 1200 1560 1800
pagesize -pg 1 -db -bbox -sgen 0 0 1910 1030
"
}
...
# End of cr_bd_fft_reamp()

cr_bd_fft_reamp ""
set_property EXCLUDE_DEBUG_LOGIC "0" [get_files fft_reamp.bd ] 
set_property GENERATE_SYNTH_CHECKPOINT "1" [get_files fft_reamp.bd ] 
set_property IS_ENABLED "1" [get_files fft_reamp.bd ] 
set_property IS_GLOBAL_INCLUDE "0" [get_files fft_reamp.bd ] 
set_property LIBRARY "xil_defaultlib" [get_files fft_reamp.bd ] 
set_property PATH_MODE "RelativeFirst" [get_files fft_reamp.bd ] 
set_property PFM_NAME "" [get_files fft_reamp.bd ] 
set_property REGISTERED_WITH_MANAGER "1" [get_files fft_reamp.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files fft_reamp.bd ] 
set_property USED_IN "synthesis implementation simulation" [get_files fft_reamp.bd ] 
set_property USED_IN_IMPLEMENTATION "1" [get_files fft_reamp.bd ] 
set_property USED_IN_SIMULATION "1" [get_files fft_reamp.bd ] 
set_property USED_IN_SYNTHESIS "1" [get_files fft_reamp.bd ] 

#call make_wrapper to create wrapper files
if { [get_property IS_LOCKED [ get_files -norecurse [list fft_reamp.bd]] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/fft_reamp.gen/sources_1/bd/fft_reamp/hdl/fft_reamp_wrapper.v" ]
} else {
  set wrapper_path [make_wrapper -fileset sources_1 -files [ get_files -norecurse [list fft_reamp.bd]] -top]
...
set_property -name "incremental_checkpoint" -value "$proj_dir/fft_reamp.srcs/utils_1/imports/synth_1/fft_reamp_wrapper.dcp" -objects $obj
...
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/fft_reamp.srcs/utils_1/imports/synth_1" -objects $obj
...
set_property -name "auto_rqs.directory" -value "$proj_dir/fft_reamp.srcs/utils_1/imports/impl_1" -objects $obj
set_property -name "incremental_checkpoint.more_options" -value "" -objects $obj
set_property -name "include_in_archive" -value "1" -objects $obj
set_property -name "gen_full_bitstream" -value "1" -objects $obj
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/fft_reamp.srcs/utils_1/imports/impl_1" -objects $obj
set_property -name "min_rqa_score" -value "0" -objects $obj
