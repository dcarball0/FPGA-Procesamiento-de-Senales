...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_AXI_Rectification is
  ...
  signal \data_reg[31]_i_9_n_0\ : STD_LOGIC;
...
\data_reg[31]_i_10\: unisim.vcomponents.LUT6
    generic map(
...
\data_reg[31]_i_11\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFFFFFFFFFFFFE"
    )
        port map (
...
\data_reg[31]_i_12\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFFFFFFFFFFFFE"
    )
        port map (
...
\data_reg[31]_i_14\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFFFFFFFFFFFFE"
    )
        port map (
...
\data_reg[31]_i_5\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFFFFFFFFFFFFE"
        ...
        port map (
      I0 => \data_reg[31]_i_9_n_0\,
      I1 => \data_reg[31]_i_10_n_0\,
      I2 => \data_reg[31]_i_11_n_0\,
      I3 => \data_reg[31]_i_12_n_0\,
      I4 => \data_reg[31]_i_13_n_0\,
      I5 => \data_reg[31]_i_14_n_0\,
      O => data_reg10_in
    );
...
\data_reg[31]_i_8\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
\data_reg[31]_i_9\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFFFFFFFFFFFFE"
    )
        port map (
